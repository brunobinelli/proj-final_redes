/*
  PROJECT: Home Alarm System - Logger Device (Fixed for ESP32 Board v3.0+)
  AUTHOR: Gemini (AI)
  DESCRIPTION: Receives logs via ESP-NOW, stores them in memory, 
  and sends them back when requested.
*/
